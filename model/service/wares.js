...
module.exports.list = function(name,cid,currentPage, cb) {
    ...
    var end = 10;
    var sql_data = 'SELECT s.*, c.id AS cid, c.name AS cname, b.name AS bname FROM wares  s, systemClassify  c,brand b '+parm+' AND s.brand = b.id AND s.classify = c.id ORDER BY dateline DESC LIMIT ?,?';
